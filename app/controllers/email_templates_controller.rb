class EmailTemplatesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @email_template.update(email_template_params)
        format.html { redirect_to @email_template, notice: "Email template was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to email_templates_path, notice: "Email template was successfully destroyed.", status: :see_other }
